...
const messageStreams = [
  {
    ...
    messages: [
      ...
      {
        id: "2",
        content: "Is there availability for a game this Saturday?",
  ...
  },
  {
    ...
    messages: [
      {
        id: "4",
        content: "Will there be snacks afterwards?",
        sentAt: Date.now(),
        senderId: "client-3",
      },
      {
        id: "5",
        content: "How many golf carts are there?",
        sentAt: Date.now(),
        senderId: "client-3",
      },
    ],
    ...
    messages: [
      {
        id: "5",
        content:
          "My golf club broke, I need to get a replacement. I will be there a little late. Sorry.",
        sentAt: Date.now() - 90000000,
        senderId: "client-4",
      },
      {
        id: "6",
        content: "I am stuck in traffic!",
        sentAt: Date.now() - 90000000,
        senderId: "client-4",
      },
      {
        id: "7",
        content: "When does the golf course close?",
...
app.get("/message-stream", authenticateToken, (req, res) => {
  ...
  if (locationId) {
    filteredStreams = filteredStreams.filter(
      (stream) => stream.locationId === locationId
    );
  }
